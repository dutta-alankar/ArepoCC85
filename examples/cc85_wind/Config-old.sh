...
#NO_SELFGRAVITY_TYPE=5         # exclude particle type from self-gravity (can be used with exact gravity)
#NO_GRAVITY_TYPE=5             # disable computation of gravity on particle type
